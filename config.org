...
*** New .org files get #+title and #+date automatically
...
date. It only touches genuinely empty files and skips capture/roam
...
(defun my/org-new-file-header ()
  "Insert #+title and #+date into a fresh empty .org file.
